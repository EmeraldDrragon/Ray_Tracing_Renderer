...
Renderer::Renderer(std::string file_path, int width, int height, Vec3 look_from, Vec3 look_at, Vec3 vup, double focal_length, double vfov, SurfaceGroup& world)
    : image_width{width}, image_height{height}, look_from{look_from}, look_at{look_at}, vup{vup}, focal_length{focal_length}, vfov{vfov}, world{world}
{
